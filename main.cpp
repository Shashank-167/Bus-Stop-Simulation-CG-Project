...
char string1[]="BUS STOP SIMULATION";
void *font1=GLUT_BITMAP_TIMES_ROMAN_24;
...
char string3[]="SHREYAS VINAYAK PATIL";
...
char string6[]="Mr. Muneshwara M S (Asst.Professor)";
...
char string7[]="Mrs. Chethana C (Asst.Professor)";
